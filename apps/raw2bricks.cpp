...
// #endif
                 ...
                 const int blockDepth)
    {
      ...
      if (blockID == -1) {
        ...
        fprintf(out,"%s.osp:",outFileName.c_str());
        for (int i=0;i<numBlocks;i++)
        ...
        // =======================================================
        // brickID == -1: create the final summary; ie, the root 
        // grid over the brickTree-block
        // =======================================================
